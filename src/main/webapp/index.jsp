			  ...
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        ...
				        <p class="col-md-8 fs-4">Nel nostro servizio potrà fare la ricerca di tutti i biglietti comprati!. </p>
				        <a class="btn btn-primary btn-lg" href="PrepareListBigliettiServlet">Lista Biglietti</a>
				      </div>
			    </div>
			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      <div class="feature col">
			        ...
			        <a href="PrepareListBigliettiServlet" class="icon-link">
